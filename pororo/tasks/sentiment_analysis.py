...
class PororoSentimentFactory(PororoFactoryBase):
    ...
    Korean (`brainbert.base.ko.general_review`)

        - dataset: Internal data
        - metric: Accuracy (94.3)

    Korean (`brainbert.base.ko.short_general_review`)

        - dataset: Internal data
        - metric: Accuracy (87.0)
    ...
    def get_available_models():
        return {
            "ko": [
                "brainbert.base.ko.general_review",
                "brainbert.base.ko.short_general_review",
